...
Output:
    ...
    type (state transition / deviation / no-progress / planning note / promotion).
...
ENTRY_PATTERNS = [
    ...
    (re.compile(r"written down|note reference|planning note|recorded at", re.IGNORECASE), "planning note"),
...
def main() -> None:
    ...
    print("Summary by kind:")
    for kind in ("promotion", "planning note", "state transition", "stage gate", "trial",
