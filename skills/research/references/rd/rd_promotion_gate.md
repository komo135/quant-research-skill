...
- [ ] **Baseline metric snapshot**: Headline metrics at promotion time,
  so drift is measurable (e.g., "primary metric 1.2, ECE 0.07, IC 0.05 on
...
| Vague "primary metric is good" without target H8 comparison | Lazy success claim | Compare against H8 final exam criteria explicitly |
